...
<div class="flex flex-col gap-10 px-5 mt-5">
    <div class="breadcrumb flex items-center gap-[30px]">
        ...
        <a href="{{route('dashboardcourses.index')}}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage Courses</a>
        <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
        ...
        <div class="flex flex-col gap-5">
            ...
            <div class="flex items-center gap-5">
                <div class="flex gap-[10px] items-center">
                    ...
                    <p class="font-semibold">{{\Carbon\Carbon::parse($course->created_at)}}</p>
                </div>
                <div class="flex gap-[10px] items-center">
                    <div class="w-6 h-6 flex shrink-0">
...
<div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
    ...
    <div class="flex flex-col gap-[30px] mt-2">
        <a href="{{ route('dashboardcourse.create.question', $course) }}" class="w-full h-[92px] flex items-center justify-center p-4 border-dashed border-2 border-[#0A090B] rounded-[20px]">
            <div class="flex items-center gap-5">
                <div>
        ...
        @empty
            <p>
                Kelas belom memiliki sebuah question.
            </p>
