...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->name('dashboard')->group(function () {
        ...
        Route::get('/learning/finis/{course}', [LearningController::class, 'learningFinish'])
            ->middleware('role:student')
            ->name('learning.finished.course');

        Route::get('/learning/raport/{course}', [LearningController::class, 'learningRaport'])
            ->middleware('role:student')
            ->name('learning.raport.course');


        // untuk menampilkan kelas yang diberikan oleh teacher
